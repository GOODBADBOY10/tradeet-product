  ...
  return (
    <div className='mx-auto w-screen border border-black md:w-full md:px-24'>
      ...
      <div className='relative md:block md:mt-4'>
            <img src='./src/assets/women.jpg' alt='' className='w-96 h-96 md:w-full md:h-96' />
            <div className='w-72 h-24 bg-blackBlack absolute top-36 left-14 text-center md:w-96 md:h-36 md:top-36 md:left-72'>
