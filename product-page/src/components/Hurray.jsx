...
const Hurray = () => {
  return (
    <div>
      <div className='container w-screen blur w-full px-6 m-auto md:w-full md:px-10 md:py-3'>
    ...
    {/* Pop up message */}
    <div className='pop-up rounded-md border w-80 md:w-96 bg-whiteWhite'>
      <div className='open-up'>
        <img src='./src/assets/hurray.png' alt='' className='w-full h-48' />
        <h2 className='text-blackBlack'>Hurray!!!!!</h2>
        <p className='text-blackBlack'>You have succesfully made your purchase, please check your items in the emails sent to you </p>
        <button type='submit' className='bg-deepBlue text-whiteWhite w-48 h-10 mt-4 rounded'><Link to='/'>Confirm</Link></button>
      </div>
    </div>
    </div>
  )
